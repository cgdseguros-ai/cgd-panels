...
(function () {
  const css = `
    ...
    *{ box-sizing:border-box; }
    ...
    .card.rank2{
      border: 4px solid #cfd6dd;
      box-shadow:
        0 0 0 3px rgba(207,214,221,.42),
        0 0 28px rgba(207,214,221,.62),
        0 0 46px rgba(207,214,221,.32),
    ...
    @keyframes podiumSilverPulse{
      from{ box-shadow: 0 0 0 2px rgba(207,214,221,.28), 0 0 16px rgba(207,214,221,.34), 0 0 26px rgba(207,214,221,.16), 0 0 40px rgba(255,255,255,.08), var(--shadow); }
      to{ box-shadow: 0 0 0 5px rgba(207,214,221,.52), 0 0 36px rgba(207,214,221,.72), 0 0 54px rgba(207,214,221,.30), 0 0 82px rgba(255,255,255,.22), var(--shadow); }
    }
  ...
  function getAllVisibleUsersForCards(){
    ...
    vals.sort((a,b)=>{
      ...
      if (na === "MANUELA" && Number(a.userId) === 813) return -1;
      if (nb === "MANUELA" && Number(b.userId) === 813) return 1;
