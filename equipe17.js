...
(function () {
  ...
  function saveCache() {
    try {
      normalizeDealsState();
      localStorage.setItem(CACHE_KEY, JSON.stringify({ at: Date.now(), dealsAll: STATE.dealsAll, lastDealsSyncAt: STATE.lastDealsSyncAt || null, lastFullDealsSyncAt: Number(STATE.lastFullDealsSyncAt || 0) || 0 }));
    } catch (_) {}
  }
  function loadCache() {
    try {
