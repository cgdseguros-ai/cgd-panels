        ...
        <div class="panelHead">
          <div class="panelUserInfo">
            ...
            <div>
              ...
              <div class="panelUserTeam">Equipe ${escHtml(user.team || "")}</div><div style="font-size:11px;font-weight:950;opacity:.82">Dia selecionado: ${fmtDateOnly(selectedDate)}</div><div style="font-size:11px;font-weight:950;opacity:.82">Dia selecionado: ${fmtDateOnly(selectedDate)}</div>
            </div>
          </div>
