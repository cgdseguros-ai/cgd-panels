      ...
      el.main.innerHTML = `
        <div class="panelHead">
          ...
          <div class="${isAdminPanelUser(user.userId) ? 'panelTools panelToolsUser1' : 'panelTools'}">
            ...
            ${genericFollowupBtn}
            ${newTaskBtn}
            ${recurBtn}${recurrenceAuditUserBtn}
            ${viewBtn}
            ${vincularFupBtn}
