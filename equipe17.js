      ...
      return `
        <div class="leadCard">
          ...
          <div class="leadMeta">
            ...
            <span style="background:${leadHelena(l) ? "#ede9fe" : "#374151"};color:${leadHelena(l) ? "#6d28d9" : "#fff"};padding:2px 6px;border-radius:999px">${leadHelena(l) ? "HELENA" : "HELENA NÃO"}</span>
            <span style="background:${leadPessoal(l) ? "#dcfce7" : "#6b7280"};color:${leadPessoal(l) ? "#166534" : "#fff"};padding:2px 6px;border-radius:999px">${leadPessoal(l) ? "PESSOAL" : "PESSOAL NÃO"}</span>
          </div>
    ...
    return `
      <div class="userCard" data-action="openUser" data-userid="${u.userId}">
        ...
        <div class="userRight">
          ...
          <div class="userLine">FOLLOW-UP do dia: <strong>${stats.followDay}</strong></div>
