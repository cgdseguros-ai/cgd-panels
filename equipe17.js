  ...
  function makeDealCard(deal, context) {
    ...
    return `
      <div class="eqd-card" style="--accent-rgb:${deal._accent}" data-deal="${deal.ID}">
        ...
        <div class="leadBtns"><button class="leadBtn" data-action="leadEdit" data-leadid="${l.ID}" data-userid="${escHtml(String(l.ASSIGNED_BY_ID || l._ownerUserId || ''))}">EDITAR</button></div>
      </div>
    `;
  }
