...
function makeUserCard(u) {
  ...
  function renderUserPanel(userId) {
    ...
    const stoppedProposalsBtn = isAdminPanelUser(user.userId) ? `<button class="eqd-btn" data-action="stoppedProposalsPanel" data-userid="${user.userId}">PROPOSTAS PARADAS</button>` : ``;
...
document.addEventListener("click", async (e) => {
    ...
    try{
      ...
      if (act === "stoppedProposalsPanel") { return openStoppedProposalsPanel({ minDays: 5, forceReload: true }); }
