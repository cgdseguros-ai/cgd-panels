...
function openMarketingPanelStub() {
  openModal("Painel MKT — em implantação", `<div style="display:grid;grid-template-columns:minmax(280px,42%) 1fr;gap:12px;min-height:65vh"><div style="border:1px solid rgba(0,0,0,.08);border-radius:16px;padding:12px;background:#fff"><div style="font-weight:950;margin-bottom:8px">Calendário MKT</div><div style="font-size:12px;opacity:.78;margin-bottom:10px">Base inicial criada. Próximo passo: calendário especial, múltiplos participantes e filtro exclusivo MKT.</div><img src="${MARKETING_LOGO_URL}" style="width:96px;height:96px;object-fit:contain;border-radius:16px;background:#fff;border:1px solid rgba(0,0,0,.08);padding:6px" /></div><div style="border:1px solid rgba(0,0,0,.08);border-radius:16px;padding:12px;background:#fff"><div style="font-weight:950;margin-bottom:8px">Agenda MKT</div><div style="font-size:12px;opacity:.78">O card 19 foi iniciado como estrutura visual. Na próxima etapa, entram criação de deals MKT, tipos fixos, calendário clicável e exibição por participantes.</div></div></div>`, { full:true, wide:true });
}
