    ...
    return new Promise((resolve) => {
      openModal("Acesso", `
        <div style="display:flex;flex-direction:column;gap:10px">
          ...
          ${isFollowupDeal(d) ? `<div><div style="font-size:11px;font-weight:900;margin-bottom:6px">FOLLOW-UP</div><select id="drFeito" style="width:100%;padding:10px;border-radius:12px;border:1px solid rgba(30,40,70,.16);font-weight:900"><option value="S">FEITO</option><option value="N">NÃO FEITO</option></select></div>` : ``}
