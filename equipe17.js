  ...
  async function openWaitingNewLeadsModal(userId, opts = {}) {
    ...
    openModal(`NOVOS LEADS (Aguardando) — ${user.name}`, `
      <div style="display:flex;justify-content:space-between;gap:10px;align-items:center;flex-wrap:wrap">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
          <input id="waitingFonteFilter" class="eqd-searchInput" style="width:160px;color:#111;background:#fff;border-color:rgba(0,0,0,.18)" placeholder="Fonte" value="${escHtml(String((opts&&opts.sourceFilter)||''))}">
          <input id="waitingOperFilter" class="eqd-searchInput" style="width:170px;color:#111;background:#fff;border-color:rgba(0,0,0,.18)" placeholder="Operadora" value="${escHtml(String((opts&&opts.operFilter)||''))}">
