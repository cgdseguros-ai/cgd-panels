  ...
  function renderProposalCard(deal, opts = {}) {
    ...
    return `
      <div class="eqd-card" style="border-left:4px solid ${stageColor};padding:4px 6px">
        <div style="display:grid;grid-template-columns:minmax(0,1fr) auto;gap:4px;align-items:start">
          <div style="min-width:0">
            ...
            <div style="font-weight:950;font-size:11px;line-height:1.05">${escHtml(bestTitleFromText(deal.TITLE || ''))}</div>
          </div>
          <div style="display:flex;gap:3px;flex-wrap:wrap;justify-content:flex-end;align-items:center">
            <select class="proposal-inline-stage" data-id="${escHtml(String(deal.ID))}" style="padding:3px 5px;border-radius:8px;border:1px solid rgba(30,40,70,.16);font-weight:900;max-width:170px;font-size:10px">${proposalCardStageOptions(deal.STAGE_ID)}</select>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(108px,1fr));gap:0 4px;margin-top:2px">${rows}</div>
      </div>`;
  }
