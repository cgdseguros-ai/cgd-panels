/* eqd.js — GET • CGD CORRETORA (v5.0)
   PATCH REAL V5 — 2026-04-30: correção atômica do reagendamento pipeline 17
  ...
  root.innerHTML = `
    <div id="eqd-app">
      <div class="eqd-topbar">
        ...
        <div class="eqd-syncRow" style="display:flex;gap:6px;align-items:center;justify-content:flex-start;flex-wrap:wrap;padding-left:60px">
          <div class="eqd-pill" id="eqd-sync-status" title="Clique para ver a fila de sincronização" style="cursor:pointer">SYNC: ok</div>
        </div>
      </div>
