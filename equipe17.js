/* eqd.js — GET • CGD CORRETORA (v5.0)
   PATCH REAL V5.7 — 2026-05-13: boot sem recorrências bloqueantes + recorrências em background
...
(function () {
  ...
  const USERS = [
    ...
    { name: "BEATRIZ LEAL", userId: 3387, team: "DELTA" },
...
restoreSyncQueue();
  ...
  const MARKETING_MEMBERS = ["1","3079","3081","3387","4945"];
