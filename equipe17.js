...
function makeUserCard(u) {
  ...
  function renderUserPanel(userId) {
    ...
    const user1AdminPanel = isAdminPanelUser(user.userId) ? `<div id="user1AdminPanel" style="display:none;gap:8px;flex-wrap:wrap;padding-top:4px">${analysisBtn}${globalNoFuBtn}${lostFupBtn}${proposalsAdminBtn}<button class="eqd-btn" data-action="syncBitrixPanel">SYNC BITRIX</button></div>` : ``;
...
${marker}` : marker;
  ...
  // PROPOSTAS PARADAS removido por solicitação do usuário.
