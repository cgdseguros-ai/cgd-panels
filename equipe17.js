  ...
  async function openProposalRequiredFieldsModal(deal, nextStageId, returnCtx = {}, patch = {}) {
    ...
    if (btn) btn.onclick = async () => {
      ...
      try {
        ...
        patchProposalDealCaches(String(deal.ID), { ...deal, ...finalPatch, _proposalStageName: proposalStageNameFromId(finalPatch.STAGE_ID || deal.STAGE_ID) });
        closeModal();
  ...
  async function openProposalStageMoveModal(dealId, returnCtx = {}) {
    ...
    btn.onclick = async () => {
      ...
      try {
        ...
        patchProposalDealCaches(String(deal.ID), { STAGE_ID: nextStage, _proposalStageName: proposalStageNameFromId(nextStage) });
        closeModal();
        openProposalsModal(String(returnCtx.userId || deal.ASSIGNED_BY_ID || ''), { ...returnCtx, noStack: true });
  ...
  async function openProposalEditor(dealId, returnCtx = {}) {
    ...
    btn.onclick = async () => {
      ...
      try {
        ...
        patchProposalDealCaches(String(deal.ID), { ...patch, _proposalStageName: proposalStageNameFromId(nextStageId) });
        closeModal();
        openProposalsModal(String(returnCtx.userId || deal.ASSIGNED_BY_ID || ''), { ...returnCtx, noStack: true });
