  ...
  const css = `
    ...
    *{ box-sizing:border-box; }
    ...
    .card.rank2{
      ...
      box-shadow:
        0 0 0 2px rgba(191,197,204,.30),
        0 0 22px rgba(191,197,204,.44),
        0 0 34px rgba(191,197,204,.22),
        var(--shadow);
      animation: podiumSilverPulse 1s infinite alternate;
    }
    .card.rank3{
    ...
    @keyframes podiumSilverPulse{
      from{ box-shadow: 0 0 0 2px rgba(191,197,204,.24), 0 0 12px rgba(191,197,204,.28), 0 0 20px rgba(191,197,204,.12), var(--shadow); }
      to{ box-shadow: 0 0 0 4px rgba(191,197,204,.40), 0 0 28px rgba(191,197,204,.52), 0 0 42px rgba(191,197,204,.22), var(--shadow); }
    }
