...
(function () {
  const css = `
    :root{
      ...
      --hdr: #000000;
      --hdrBorder: rgba(255,255,255,.08);

      --text: rgba(245,246,248,.96);
      --muted: rgba(245,246,248,.70);

      --card: rgba(245,242,234,.96);
      --card2: rgba(245,242,234,.90);
    ...
    *{ box-sizing:border-box; }
    ...
    #app{
      ...
      color: var(--text);
      background:
        radial-gradient(1200px 520px at 12% 0%, rgba(255,255,255,.06), transparent 60%),
        radial-gradient(1000px 520px at 85% 8%, rgba(255,255,255,.04), transparent 60%),
    ...
    .spItem:hover{ background: rgba(255,255,255,.06); }
    .spMain{ font-size:14px; color: #fff; line-height: 1.25; }
    .spSub{ font-size:12px; color: rgba(255,255,255,.70); margin-top:2px; }
    ...
    @media (max-width: 1600px){
      .gridTop{ grid-template-columns: repeat(3, minmax(320px, 1fr)); }
    }
    @media (max-width: 1180px){
      .gridTop{ grid-template-columns: repeat(2, minmax(320px, 1fr)); }
      h1{ font-size: 20px; }
    }
    ...
    .stat span{ font-size: 18px; color: var(--cardMuted); font-weight:800; line-height:1.2; }
    ...
    .zeroName{ font-size:13px; font-weight:800; color: #fff; max-width:160px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
    ...
    .table td{ color: rgba(245,247,255,.90); background: rgba(255,255,255,.05); }
    .table tr:hover td{ background: rgba(255,255,255,.08); }
    .tdRight{ text-align:right; white-space:nowrap; }
    .smallNote{ opacity:.95; font-size:14px; color: rgba(245,247,255,.80); }
      ...
      <div class="head">
        <div class="titleRow">
          <div class="colTitle">
            ...
            <div class="rankBadge">#${rankMap.get(sid) || "—"}</div>
  ...
  function setTheme(cls){
    ...
    localStorage.setItem("cgd_theme", "theme-dark");
  }
