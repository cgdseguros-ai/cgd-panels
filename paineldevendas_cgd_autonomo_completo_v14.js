  ...
  const css = `
    ...
    *{ box-sizing:border-box; }
    ...
    .pillSorteioPct{
      ...
      background: linear-gradient(180deg, #111 0%, #1d1600 100%);
      box-shadow:
    ...
    .sorteioPctValue{
      ...
      color: #ffd84d;
      text-shadow:
        0 0 8px rgba(255,216,77,.18),
        0 0 16px rgba(255,216,77,.12);
      letter-spacing: .2px;
    }
    ...
    <header>
      ...
      <div class="right">
        <div class="rightRow row1">
          ...
          <div class="pill pillSorteioPct" title="% da meta geral atingida (produzido total / meta sorteio)">
            <span class="sorteioPctLabel">% sorteio:</span>
            <b id="sorteioPct" class="sorteioPctValue">—</b>
          </div>
