/* financeiro.js — CGD Financeiro (Bitrix via Worker)
   v44: PATCH estabilidade raiz + sem sobrescrever tela + render protegido
...
(function () {
  ...
  function finCleanExternalFatalPanels() {
    try {
      ...
      if (!body) return;
      var finRoot = document.getElementById("fin-root");
      var finReady = !!(finRoot && finRoot.querySelector && finRoot.querySelector(".fin-page"));
      if (finReady) {
        try { document.documentElement && document.documentElement.classList && document.documentElement.classList.add("fin-v44-html"); } catch (_) {}
        try { body.classList && body.classList.add("fin-v44-active"); } catch (_) {}
      }
      var nodes = Array.prototype.slice.call(body.children || []);
      for (var i = 0; i < nodes.length; i++) {
        var n = nodes[i];
        if (!n || n.id === "fin-root" || n.tagName === "SCRIPT" || n.tagName === "STYLE" || n.tagName === "LINK" || n.tagName === "META") continue;
        var tx = String(n.innerText || n.textContent || "");
        if (finReady || (/Falha ao carregar o painel/i.test(tx) && /(Erro JS|reading ['"]init['"]|core\.min\.js)/i.test(tx))) {
          n.style.setProperty("display", "none", "important");
          n.style.setProperty("visibility", "hidden", "important");
          n.setAttribute("data-fin-hidden-bitrix-external", "1");
        }
      }
    } catch (_) {}
  }
  ...
  function injectFinanceiroCSS() {
    ...
    css += "\n/* PATCH v44: isolamento visual da página Bitrix. */\nhtml.fin-v44-html, body.fin-v44-active{margin:0!important;min-height:100vh!important;background:#f4f5f7!important;}\nbody.fin-v44-active > *:not(#fin-root):not(script):not(style):not(link):not(meta):not(title){display:none!important;visibility:hidden!important;}\nbody.fin-v44-active #fin-root{display:block!important;visibility:visible!important;min-height:100vh!important;position:relative!important;z-index:1!important;}";
  ...
  // Root
  // =========================
  // PATCH v44: isola o Financeiro em #fin-root. Antes, em páginas sem #fin-root,
  ...
  var root = ensureFinanceRootV44();
  try { finCleanExternalFatalPanels(); } catch (_) {}
  ...
  function finSafeSetBodyClassV44() {
    try { document.documentElement && document.documentElement.classList && document.documentElement.classList.add("fin-v44-html"); } catch (_) {}
    try { document.body && document.body.classList && document.body.classList.add("fin-v44-active"); } catch (_) {}
    try { finCleanExternalFatalPanels(); } catch (_) {}
  }

  function renderMinimalFinanceShellV44(reason) {
    try {
      root.innerHTML =
        '<div class="fin-page">' +
          '<header class="fin-topbar">' +
            '<div class="fin-top-left"><img class="fin-top-logo" src="' + esc(CFG.LOGO_URL) + '" alt="CGD"><div><div class="fin-top-title">Financeiro CGD</div><div class="fin-top-sub">MODO SEGURO v44</div></div></div>' +
          ...
          '<main class="fin-shell"><section class="fin-panel"><div class="fin-panel-inner">' +
            ...
            '<div class="fin-table-wrap" style="margin-top:12px"><table class="fin-table"><thead><tr><th>ID</th><th>Favorecido/Pagador</th><th>Centro</th><th>Tipo</th><th>Competência</th><th>Data Prev.</th><th>Data Real</th><th>Previsto</th><th>Realizado</th><th>Etapa</th><th>Ações</th></tr></thead><tbody id="fin-tbody"><tr><td colspan="11" class="fin-muted">Carregando modo seguro v44...</td></tr></tbody></table></div>' +
      ...
      try { root.innerHTML = '<div style="padding:16px;font-family:system-ui">Financeiro em modo seguro v44. Recarregue a página.</div>'; } catch(_) {}
    }
  }
  ...
  function renderAfterFilter() {
    // PATCH v44: renderização por partes. Um erro em gráfico/sidebar/pager não pode
    ...
    try {
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        html.push('<tr>' +
          '<td></td>' +
          '<td class="fin-mono">#' + esc(d.ID || '') + '</td>' +
          '<td><div class="fin-strong">' + esc(fav) + '</div><div class="fin-small fin-muted">fallback bruto v44</div></td>' +
      ...
      try { toast('Modo seguro v42 ativado: lançamentos carregados preservados.', 'err'); } catch(_) {}
      return true;
    } catch (e) {
      try { console.error('[Financeiro][fallback bruto v44] falhou', e); } catch(_) {}
      return false;
    }
  }
  ...
  function openDiagnosticsModal() {
    ...
    Promise.allSettled([
      ...
      host.innerHTML = '<table class="fin-table" style="min-width:0"><tbody>' +
        ...
        line('Versão JS', 'v44 raiz isolada + render protegido', true) +
    ...
    return listDealsAll()
      .then(function (deals) {
        ...
        try {
          ...
          if ((S.deals || []).length && !(S.filtered || []).length) {
            renderRawDealsFallback(S.deals, "Filtragem normal zerou a lista; fallback bruto v44 ativado.");
          }
        } catch (eApply) {
      ...
      .catch(function (e) {
        ...
        if (/Maximum call stack size exceeded/i.test(msg)) {
          msg = "Maximum call stack evitado: mantendo lançamentos já carregados em modo bruto v44.";
        }
        S.lastApiError = msg;
    ...
    return loadInstitutionalState()
      ...
      .then(function () {
        try { render(); } catch (eRender) {
          ...
          renderMinimalFinanceShellV44("Render principal falhou; modo seguro v44 ativado.");
        }
      ...
      .catch(function (e) {
        ...
        if (!document.getElementById('fin-tbody')) renderMinimalFinanceShellV44("Boot interrompido; modo seguro v44 preservou a tela.");
        if ((S.deals || []).length && renderRawDealsFallback(S.deals, bootMsg)) return;
        var tb = document.getElementById('fin-tbody');
        if (tb) tb.innerHTML = '<tr><td colspan="11" class="fin-muted">Modo seguro v44 preservou o painel. Erro: ' + esc(bootMsg) + '</td></tr>';
        try { toast("Modo seguro v44: " + bootMsg, "err"); } catch (_) {}
      })
      .finally(function () {
