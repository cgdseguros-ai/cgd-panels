      ...
      var html =
        '<div class="fin-row" style="gap:8px;flex-wrap:wrap;margin-bottom:10px;justify-content:space-between">' +
          ...
          '<div class="fin-row" style="gap:8px;flex-wrap:wrap">' +
            (isRec ? '<button class="fin-btn" id="b-import-rec">UPLOAD CSV</button><button class="fin-btn" id="b-export-rec">EXPORTAR CSV</button>' : '') +
          '</div>' +
        '</div>' +
        '<div class="fin-table-wrap"><table class="fin-batch-table"><thead><tr>' +
          '<th style="min-width:180px">CENTRO</th>' +
    ...
    var m = modal(
      ...
      '<div class="fin-modal-body">' +
        ...
        '<div class="fin-row" style="justify-content:space-between;margin-top:10px;flex-wrap:wrap">' +
          '<div class="fin-row" style="gap:8px;flex-wrap:wrap"><button class="fin-btn" id="cc-add">+ Linha</button><button class="fin-btn" id="cc-import">UPLOAD CSV</button></div>' +
