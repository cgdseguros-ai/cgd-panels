/* financeiro.js — CGD Financeiro (Bitrix via Worker)
   v31: CARTÕES edição estável de parcelas; save visível e sem travar modal
    ...
    function openCardLaunchEdit(id) {
      ...
      var em = modal(
        ...
        '<div class="fin-modal-body">' +
          ...
          '<div id="ce-status" class="fin-muted" style="font-weight:900;margin-top:10px;min-height:20px"></div>' +
          '<div class="fin-row fin-row--right" style="margin-top:14px;gap:8px">' +
            ...
            '<button type="button" id="ce-save" style="appearance:none;border:0;background:#2563eb;color:#fff;font-weight:950;font-size:12px;padding:11px 18px;border-radius:12px;min-width:145px;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 8px 18px rgba(37,99,235,.22)">Salvar edição</button>' +
          '</div>' +
        '</div>'
      );
      ...
      function setEditButtonBusy(busy, label) {
        ...
        saveBtn.style.minWidth = '145px';
        saveBtn.style.opacity = busy ? '0.82' : '1';
      ...
      function runSaveCardEdit() {
        ...
        try {
          ...
          p.then(function(){
            ...
            setEditStatus('Edição salva com sucesso.', false);
            ...
            setTimeout(function(){ try { em.close(); } catch (_) {} }, 250);
          }).catch(function(err){
            saving = false;
            setEditButtonBusy(false);
