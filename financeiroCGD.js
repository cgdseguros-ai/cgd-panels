...
(function () {
  ...
  function renderMinimalFinanceShellV43(reason) {
    try {
      root.innerHTML =
        '<div class="fin-page">' +
          '<header class="fin-topbar">' +
            '<div class="fin-top-left"><img class="fin-top-logo" src="' + esc(CFG.LOGO_URL) + '" alt="CGD"><div><div class="fin-top-title">Financeiro CGD</div><div class="fin-top-sub">MODO SEGURO v43</div></div></div>' +
      ...
      try { root.innerHTML = '<div style="padding:16px;font-family:system-ui">Financeiro em modo seguro v43. Recarregue a página.</div>'; } catch(_) {}
    }
  }
    ...
    try {
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        html.push('<tr>' +
          '<td></td>' +
          '<td class="fin-mono">#' + esc(d.ID || '') + '</td>' +
          '<td><div class="fin-strong">' + esc(fav) + '</div><div class="fin-small fin-muted">fallback bruto v43</div></td>' +
      ...
      try { console.error('[Financeiro][fallback bruto v43] falhou', e); } catch(_) {}
      return false;
    }
  }
  ...
  function openDiagnosticsModal() {
    ...
    Promise.allSettled([
      ...
      host.innerHTML = '<table class="fin-table" style="min-width:0"><tbody>' +
        ...
        line('Versão JS', 'v43 raiz isolada + render protegido', true) +
      ...
      .then(function (deals) {
        ...
        try {
          ...
          if ((S.deals || []).length && !(S.filtered || []).length) {
            renderRawDealsFallback(S.deals, "Filtragem normal zerou a lista; fallback bruto v43 ativado.");
          }
        } catch (eApply) {
    ...
    return loadInstitutionalState()
      ...
      .then(function () {
        try { render(); } catch (eRender) {
          ...
          renderMinimalFinanceShellV43("Render principal falhou; modo seguro v43 ativado.");
        }
      ...
      .catch(function (e) {
        ...
        if (!document.getElementById('fin-tbody')) renderMinimalFinanceShellV43("Boot interrompido; modo seguro v43 preservou a tela.");
