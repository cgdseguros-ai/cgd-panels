/* financeiro.js — CGD Financeiro (Bitrix via Worker)
   v19: corrige BRL, datas ISO com timezone, edição mensal por dia e valores em recorrências
...
(function () {
  ...
  function upsertCardInvoiceDeal(cardId, dueIso, total, closeIso, count) {
    ...
    fields[CFG.F.OBS] = "FIN_CARD_INVOICE:1 • FIN_CARD_INVOICE_DUE:" + dueIso + " • Cartão: " + cardName + " • Vencimento fixo: " + toDisplayDate(dueIso) + (closeIso ? " • Fechamento: " + toDisplayDate(closeIso) : "") + " • Itens: " + String(count || 0);
