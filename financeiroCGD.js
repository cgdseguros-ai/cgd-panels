  ...
  function openDiagnosticsModal() {
    ...
    Promise.allSettled([
      ...
      host.innerHTML = '<table class="fin-table" style="min-width:0"><tbody>' +
        ...
        line('Versão JS', 'v40 rollback estável sem proxy alternativo', true) +
    ...
    return listDealsAll()
      ...
      .catch(function (e) {
        ...
        if (/Maximum call stack size exceeded/i.test(msg)) {
          msg = "Worker/Bitrix ainda recusou a consulta financeira. Ative o modo seguro v38 e abra DIAGNÓSTICO para ver a chamada exata.";
        }
        S.lastApiError = msg;
