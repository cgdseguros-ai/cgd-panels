...
(function () {
  ...
  /* ================= CONFIG ================= */
  const PAINEL_CGD_VERSAO = "V6.1.1";
  const PAINEL_CGD_ULTIMA_VERSAO = "04/06/2026 às 09:30";
  ...
  const OTHER_SELLERS = [
    ...
    { label: "USER 4945", userId: 4945 },
    { label: "USER 5265", userId: 5265 },
    { label: "USER 4741", userId: 4741 },
    { label: "USER 5673", userId: 5673 },
  ];
