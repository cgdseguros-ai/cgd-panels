...
(function () {
  ...
  async function ensureUsersAndResolve(){
    ...
    const resolveArray = (arr) => {
      for (const s of arr){
        ...
        if (isBlockedSeller(s)) s.userId = null;
      }
    };
  ...
  function renderCard(container, seller, rankMap){
    ...
    const st = statsBySellerId[sid] || { andamentoQtd:0, andamentoValor:0, docsQtd:0, pagQtd:0, metaMes:0, metaPct:0, produzidoMes:0 };
