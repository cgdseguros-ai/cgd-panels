...
(function () {
    ...
    <header>
      <div class="brand">
        ...
        <div class="titles">
          ...
          <div class="sub">(BITRIX24) • V6 COMPLETA 31/05/2026</div>
        </div>
      </div>
  ...
  /* ================= CONFIG ================= */
  const PAINEL_CGD_VERSAO = "2026-05-31-userlist-v4-forcado";
  console.log("Painel CGD carregado:", PAINEL_CGD_VERSAO);
